...
#define SLOTFRAME_LENGTH    13 //should be in decimal 101
...
#define SCHEDULE_MINIMAL_6TISCH_SLOTOFFSET_TEST                   7 
#define SCHEDULE_MINIMAL_6TISCH_CHANNELOFFSET_TEST                6 
...
#define NUMSLOTSOFF          5 //default 20
